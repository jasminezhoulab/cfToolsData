...
#'
#' @format A data frame containing the lung cancer-specific marker positions
...
#' \item{LUNG_normal}{Marker parameters of normal lung tissue}
#' \item{LUNG_tumor}{Marker parameters of lung tumor tissue}
#' \item{WBC}{Marker parameters of white blood cell}
#' \item{normal_plasma}{Marker parameters of normal plasma}
#' \item{type}{Marker type}
#' }
#' @usage data("LUNG.tumorMarkerParams.hg19")
#'
